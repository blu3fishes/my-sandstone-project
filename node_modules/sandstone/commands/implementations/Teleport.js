...
__decorate([
    decorators_1.command('facing', { parsers: { '0': _variables_1.coordinatesParser } }),
...
class Teleport extends Command_1.Command {
    constructor() {
        super(...arguments);
        this.tp = (...args) => {
            if (args.length === 2 && (args[1] instanceof _variables_1.VectorClass || typeof args[1] === 'string')) {
...
__decorate([
    decorators_1.command('tp', {
        hasSubcommands: true,
        isRoot: true,
        executable: true,
        parsers: {
            '0': _variables_1.coordinatesParser,
            '1': _variables_1.coordinatesParser,
            '2': _variables_1.rotationParser,
        },
    }),
    __metadata("design:type", Function)
], Teleport.prototype, "tp", void 0);
