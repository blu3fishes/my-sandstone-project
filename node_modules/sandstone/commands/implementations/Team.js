...
__decorate([
    decorators_1.command(['team', 'add'], {
        isRoot: true,
        parsers: {
            '1': (displayName) => new _variables_1.JSONTextComponentClass(displayName),
        },
    }),
...
__decorate([
    decorators_1.command(['team', 'leave'], { isRoot: true }),
    __metadata("design:type", Object)
...
__decorate([
    decorators_1.command(['team', 'remove'], { isRoot: true }),
    __metadata("design:type", Object)
