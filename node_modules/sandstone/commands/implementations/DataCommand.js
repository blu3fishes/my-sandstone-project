...
exports.DataCommand = exports.DataRemove = exports.DataModify = exports.DataModifyType = exports.DataModifyValues = exports.DataMerge = exports.DataGet = void 0;
...
__decorate([
    decorators_1.command(getCmd('block'), { isRoot: true, parsers: { '0': _variables_1.coordinatesParser } }),
...
__decorate([
    decorators_1.command(mergeCmd('block'), { isRoot: true, parsers: { '0': _variables_1.coordinatesParser, '1': _variables_1.nbtParser } }),
    __metadata("design:type", Object)
], DataMerge.prototype, "block", void 0);
__decorate([
    decorators_1.command(mergeCmd('entity'), { isRoot: true, parsers: { '1': _variables_1.nbtParser } }),
    __metadata("design:type", Object)
], DataMerge.prototype, "entity", void 0);
__decorate([
    decorators_1.command(mergeCmd('storage'), { isRoot: true, parsers: { '1': _variables_1.nbtParser } }),
    __metadata("design:type", Object)
...
__decorate([
    decorators_1.command(['from', 'block'], { parsers: { '0': _variables_1.coordinatesParser } }),
    __metadata("design:type", Object)
...
__decorate([
    decorators_1.command('value', { parsers: { '0': _variables_1.nbtParser } }),
    __metadata("design:type", Object)
], DataModifyValues.prototype, "value", void 0);
exports.DataModifyValues = DataModifyValues;
...
exports.DataModifyType = DataModifyType;
...
__decorate([
    decorators_1.command(modifyCmd('block'), {
        isRoot: true, executable: false, hasSubcommands: true, parsers: { '0': _variables_1.coordinatesParser },
    }),
    __metadata("design:type", Object)
...
__decorate([
    decorators_1.command(removeCmd('block'), {
        isRoot: true, executable: true, parsers: { '0': _variables_1.coordinatesParser },
    }),
    __metadata("design:type", Object)
...
class DataCommand extends Command_1.Command {
    constructor() {
        super(...arguments);
