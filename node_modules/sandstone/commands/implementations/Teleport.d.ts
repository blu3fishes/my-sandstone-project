...
import type { Coordinates, MultipleEntitiesArgument, Rotation, SingleEntityArgument } from 'src/arguments';
export declare class TeleportFacing extends Command {
     ...
     */
    facingEntity: (entity: SingleEntityArgument, anchor?: "feet" | "eyes" | undefined) => void;
}
