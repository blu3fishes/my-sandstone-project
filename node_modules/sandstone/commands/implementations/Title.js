...
__decorate([
    decorators_1.command('title', {
        parsers: {
            '0': (title) => new _variables_1.JSONTextComponentClass(title),
        },
    }),
    __metadata("design:type", Object)
...
__decorate([
    decorators_1.command('subtitle', {
        parsers: {
            '0': (subtitle) => new _variables_1.JSONTextComponentClass(subtitle),
        },
    }),
    __metadata("design:type", Object)
...
__decorate([
    decorators_1.command('actionbar', {
        parsers: {
            '0': (actionbar) => new _variables_1.JSONTextComponentClass(actionbar),
        },
    }),
    __metadata("design:type", Object)
