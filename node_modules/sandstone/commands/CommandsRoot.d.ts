...
import type { BIOMES, BLOCKS, Coordinates, ENTITY_TYPES, GAMEMODES, GAMERULES, ITEMS, JSONTextComponent, MessageOrSelector, MultipleEntitiesArgument, MultiplePlayersArgument, RootNBT, Rotation, SingleEntityArgument, SinglePlayerArgument, SOUND_EVENTS, SOUND_SOURCES, STRUCTURES } from 'src/arguments';
...
export declare class CommandsRoot {
    ...
    difficulty: (difficulty?: import("src/arguments").DIFFICULTIES | undefined) => void;
    effect: Effect;
    enchant: (targets: MultipleEntitiesArgument, enchantment: LiteralUnion<import("src/arguments").ENCHANTMENTS>, level?: number | undefined) => void;
     ...
     */
    help: (command_?: LiteralUnion<"list" | "advancement" | "recipe" | "schedule" | "item" | "tag" | "weather" | "team" | "gamemode" | "execute" | "attribute" | "bossbar" | "clone" | "data" | "datapack" | "debug" | "defaultgamemode" | "difficulty" | "effect" | "give" | "clear" | "enchant" | "scoreboard" | "comment" | "experience" | "fill" | "functionCmd" | "forceload" | "gamerule" | "help" | "kill" | "locate" | "locatebiome" | "loot" | "me" | "msg" | "particle" | "playsound" | "raw" | "reload" | "say" | "seed" | "setblock" | "setidletimeout" | "setworldspawn" | "spawnpoint" | "spectate" | "spreadplayers" | "stopsound" | "summon" | "teammsg" | "teleport" | "tellraw" | "time" | "title" | "trigger" | "w" | "worldborder" | "tm" | "tp" | "xp" | "tell"> | undefined, ...parameters: string[]) => void;
    /**
    ...
    spreadplayers: ((center: import("src/arguments").ColumnCoordinates, spreadDistance: number, maxRange: number, respectTeams: boolean, targets: MultipleEntitiesArgument) => void) & ((center: import("src/arguments").ColumnCoordinates, spreadDistance: number, maxRange: number, underHeight: number, respectTeams: boolean, targets: MultipleEntitiesArgument) => void);
    /**
     * Stops a given sound.
     *
    ...
    trigger: (objective: import("src/arguments").ObjectiveArgument) => import("./implementations").TriggerArguments;
    weather: Weather;
