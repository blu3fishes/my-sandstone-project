...
- 지도제작자가 '기능공' 레벨을 달성할 경우, 에메랄드 조합대, 에메랄드 큐브를 판매한다. (에메랄드 3개)

- 에메랄드 큐브는 재고를 매일 최대 20번 채운다.

- 에메랄드 큐브는 '잠재 인챈트'를 최대 '레어' 등급까지만 올려준다.
 
- 지도제작자가 '달인' 레벨을 달성할 경우, 루비 큐브를 판매한다. (에메랄드 3개 + 드래곤의 숨결)

- 루비 큐브는 재고를 매일 최대 10번 채운다.
 
## 큐브 확률표

1. 동일한 등급 내에서, 3개의 잠재능력이 출현된다.
